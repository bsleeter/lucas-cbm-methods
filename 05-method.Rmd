...
All scenario simulations were run on an annual timestep for the period 2001-2020 at 1-km x 1-km spatial resolution. The primary simulation included the combined effects of LULC change, ecosystem disturbance, and climate change on the carbon balance of forest ecosystems in the conterminous United States. The better understand the major controlling processes of carbon dynamics, we also ran two additional simulations where a) no LULC or disturbance was simulated, and b) no climate variability and/or change was simulated. Outputs from the simulations are available as both spatial and tabular files. Spatial outputs include annual carbon stocks and fluxes, LULC composition (i.e. state class maps and forest age), and LULC transitions. 
